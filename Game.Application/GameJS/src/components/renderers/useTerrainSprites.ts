...
const color: Record<VisualTerrainType, string> = {
    ...
    "Permafrost": "white",
    "Tundra": "rgb(15,59,59)",
    "ColdParklands": "rgb(144,144,122)",
    "ConiferousForests": "rgb(29, 96, 96)",
    "CoolDeserts": "rgb(170, 192, 102)",
    "Steppes": "rgb(82, 154, 82)",
    "MixedForests": "rgb(10, 154, 118)",
    "HotDeserts": "rgb(212, 255, 77)",
    "Chaparral": "rgb(82, 205, 82)",
    "DeciduousForests": "rgb(0, 205, 123)",
    "Savanna": "rgb(144, 255, 77)",
    "TropicalSeasonalForests": "rgb(77, 255, 77)",
...
const terrainSpriteDefinitions: Record<VisualTerrainType, SpriteDefinition> = {
    ...
    "CoolDeserts": { ...dw4Plains, fallbackColor: color["CoolDeserts"] },
    "Steppes": { ...dw4Bushes, fallbackColor: color["Steppes"] },
    "Chaparral": { ...dw4Bushes, fallbackColor: color["Chaparral"] },
    "ColdParklands": { ...dw4SnowyBushes, fallbackColor: color["ColdParklands"] },
    "Tundra": { ...dw4SnowyPlains, fallbackColor: color["Tundra"] },
    "ConiferousForests": { ...dw4SnowyTwoTrees, fallbackColor: color["ConiferousForests"] },
    "Permafrost": { ...dw4Clouds, fallbackColor: color["Permafrost"] },
    "Savanna": { ...dw4Plains, fallbackColor: color["Savanna"] },
    "TropicalSeasonalForests": { ...dw4GreenSomething, fallbackColor: color["TropicalSeasonalForests"] },
    ...
    "MixedForests": { ...dw4GreenTwoTrees, fallbackColor: color["MixedForests"] },
